...
export default function SignInPage() {
  ...
  const onSubmit = async (e) => {
    ...
    if (isRegisterMode && nin && !validateNIN(nin)) {
    ...
    try {
      ...
      const errorMessages = {
        ...
        OAuthAccountNotLinked: "Try using a different sign-in method.",
        CredentialsSignin: isRegisterMode
          ? "Registration failed. Try again."
          : "Invalid email or password.",
        AccessDenied: "You don't have permission to access this.",
        Configuration: isRegisterMode
          ? "Registration unavailable right now."
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <img
          src="https://images.pexels.com/photos/3184328/pexels-photo-3184328.jpeg?auto=compress&cs=tinysrgb&w=800&h=800"
          alt="Nigerian professionals collaborating on data privacy solutions"
          ...
          <div className="text-center text-white">
            ...
            >
              ...
              <p className="text-lg text-white/90">
                Join the movement for data transparency in Nigeria
              </p>
            </motion.div>
          </div>
        </div>
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              {isRegisterMode
                ? "Join thousands protecting their data privacy"
                : "Sign in to your data privacy dashboard"}
            </p>
          </div>
